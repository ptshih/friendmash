...
//  [getRequest addRequestHeader:@"Content-Type" value:@"application/json"];
  ...
  [getRequest addRequestHeader:@"X-Session-Key" value:APP_DELEGATE.sessionKey];
  [getRequest addRequestHeader:@"X-User-Id" value:APP_DELEGATE.currentUserId];
...
+ (ASIHTTPRequest *)postRequestWithBaseURLString:(NSString *)baseURLString andParams:(NSString *)params andPostData:(NSData *)postData isGzip:(BOOL)isGzip withDelegate:(id)delegate {
  ...
  [postRequest addRequestHeader:@"X-Session-Key" value:APP_DELEGATE.sessionKey];
  [postRequest addRequestHeader:@"X-User-Id" value:APP_DELEGATE.currentUserId];
