...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
  ...
  if (self) {
    self.howToPlay = [@"Friendmash is a fun, new, and exciting way to view Facebook profile pictures on your mobile device.\n\nNormally, Friendmash will show profiles pictures from all around the world. In \"Friends Only Mode\" we will only show profile pictures of your friends.\n\nTo start mashing, choose a gender and two profile pictures will be shown.\n\nTap the profile picture you like better. Long press to zoom in on any profile picture. If you can't decide which picture is better, just hit the refresh button in the top right corner to show two new pictures." retain];
