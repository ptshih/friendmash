...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil {
  ...
  if (self) {
    self.howToPlay = [@"Friendmash is a fun, new, and exciting way to view and compare Facebook profile pictures on your mobile device.\n\nNormally, Friendmash will show profile pictures from all around the world. In \"Friends Only Mode\" we will only show pictures of your friends. In \"Friends of Friends Mode\" we will only show you pictures of your extended social network.\n\nTo start mashing, simply choose a gender and two profile pictures will be shown.\n\nTap the picture you like better or long press (tap and hold) to zoom in on any picture. If you can't decide which picture is better, just hit the refresh button in the top right corner to load two new pictures." retain];
